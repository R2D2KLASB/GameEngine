...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\game_engine\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\game_engine\hook\ament_prefix_path.bat"
