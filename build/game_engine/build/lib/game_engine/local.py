...
def play(player1, player2, size):
    ...
    player1 = Player(size[0], size[1], 'Player1') if player1 == 'console' else AIPlayer(size[0], size[1], 'ai1', True)
    clear()
    player2 = Player(size[0], size[1], 'Player2') if player2 == 'console' else AIPlayer(size[0], size[1], 'ai2', False)
